...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_pystyy_syomaan_edullisesti_kun_kortilla_edullisen_lounaan_verran(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        # Kortilla on rahaa 2.5
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti),"Kortilla on rahaa 0.0 euroa")

    def test_pystyy_syomaan_maukkaasti_kun_kortilla_maukkaan_lounaan_verran(self):
