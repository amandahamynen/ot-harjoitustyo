...
class UserCreation:
    ...
    def initialize(self):
        ...
        label = tkinter.Label(self.creation_frame, text="Create a new user", fg="black", bg="white", font=("Arial", 25))
        ...
        button_create_user = tkinter.Button(master=self.creation_frame, text="Create user", command=self.creation_handler, fg="white", bg="white", bd=0)
        button_login_screen = tkinter.Button(master=self.creation_frame, text="Go back", command=self.handle_login, fg="white", bg="white", bd=0)
    ...
    def creation_handler(self):
        ...
        if len(username) == 0 or len(password) == 0:
            ...
            self.error_label = tkinter.Label(self.creation_frame, text="Username and password are required", fg="black", bg="white")
        ...
        try:
            ...
            if self.error_label:
                self.error_label.destroy()
            self.error_label = tkinter.Label(self.creation_frame, text="Username already exists", fg="black", bg="white")
            self.error_label.grid(padx=50, pady=10)


    def first_name_field(self):
        label = tkinter.Label(master=self.creation_frame, text="First name", fg="black", bg="white")
    ...
    def last_name_field(self):
        label = tkinter.Label(master=self.creation_frame, text="Last name", fg="black", bg="white")
    ...
    def username_field(self):
        label = tkinter.Label(master=self.creation_frame, text="Username", fg="black", bg="white")
    ...
    def password_field(self):
        label = tkinter.Label(master=self.creation_frame, text="Password", fg="black", bg="white")
