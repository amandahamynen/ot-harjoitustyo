...
class LoginScreen():
    ...
    def initialize(self):
        ...
        button_login = tkinter.Button(master=self.login_frame, text="Login", command=self.login_handler, fg="white", bg="white", bd=0)
        button_create_user = tkinter.Button(master=self.login_frame, text="Create a new user", command=self.handle_user_creation, fg="white", bg="white", bd = 0)
    ...
    def username_field(self):
        label = tkinter.Label(master=self.login_frame, text="Username", fg="black", bg="white")
    ...
    def password_field(self):
        label = tkinter.Label(master=self.login_frame, text="Password", fg="black", bg="white")
    ...
    def login_handler(self):
        ...
        try:
            ...
            self.error_label = tkinter.Label(self.login_frame, text="Invalid username or password", fg="black", bg="white")
